...
/*   Updated: 2021/02/25 22:02:16 by romanbtt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

void		put_in_token_word(t_tokens *tk, t_lexer *lx, t_minishell *msh)
{
...
t_tokens	*general_state(t_tokens *tk, t_lexer *lx, t_minishell *msh)
{
